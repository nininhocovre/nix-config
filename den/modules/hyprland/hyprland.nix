  ...
  flake.modules.homeManager.hyprland = 
    ...
    in
    {
      ...
      wayland.windowManager.hyprland = {
        ...
        settings = {
          "$mainMod" = "SUPER";
          "$term" = "${getExe pkgs.${vars.terminal}}";
          "$editor" = "code --disable-gpu";
          "$fileManager" = "$term --class \"tuiFileManager\" -e ${vars.tuiFileManager}";
          ...
          input = {
            kb_layout = "${vars.kbdLayout},ru";
            kb_variant = "${vars.kbdVariant},";
          ...
          bind = [
            ...
            "$mainMod, backspace, exit" # kill hyperland session
            "$mainMod, delete, exec, systemctl reboot" # reboot
